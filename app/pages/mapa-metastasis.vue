      ...
      <div class="px-4 sm:px-6 lg:px-8 max-w-[1280px] mx-auto">
        ...
        <section class="order-1 mb-14" aria-labelledby="dianas-resumen">
          ...
          <!-- (BIOPSIA · por qué el ilíaco y no el fémur) — explica el cambio de criterio
               (señal cruda → mejor tejido seguro para la vacuna), para que no parezca arbitrario. -->
          <details class="alert-callout mt-5 leading-relaxed">
            <summary class="cursor-pointer font-semibold">{{ L('Por qué la vía de biopsia mira al ilíaco y no al fémur (el de más señal)', 'Why the biopsy route looks at the iliac, not the femur (the one with the most signal)') }}</summary>
            <p class="mt-2">{{ L('Por señal cruda, el foco con más azúcar (FDG) es el fémur (#16). Para la biopsia de caracterización molecular orientada a la vacuna, dos cosas cambian la lectura —conviene verlo para que no parezca arbitrario—: (1) el #16 está en el cuello femoral, hueso de carga crítica → extraer cores conlleva riesgo de fractura, algo que valoran Oncología Radioterápica/ortopedia; (2) lo que esta biopsia necesita es tejido con ARN de buena calidad del clon adecuado, no el SUV más alto — y esa misma biología (un clon agresivo en progresión) aparece también en el ilíaco supra-acetabular (#14), con acceso seguro. El criterio pasó de «la señal más alta» a «el mejor tejido, de forma segura». El #16 sigue en la tabla, con su aviso de fractura. Describe; no concluye — la diana la elige el equipo.', 'By raw signal, the focus with the most sugar (FDG) is the femur (#16). For the molecular-characterization biopsy aimed at the vaccine, two things change the reading — worth seeing so it does not look arbitrary: (1) #16 is in the femoral neck, critical weight-bearing bone → taking cores carries fracture risk, assessed by Radiation Oncology/orthopedics; (2) what this biopsy needs is good-quality RNA tissue from the right clone, not the highest SUV — and that same biology (a progressing aggressive clone) also appears in the supra-acetabular iliac (#14), with safe access. The criterion shifted from “the highest signal” to “the best tissue, safely”. #16 stays in the table, with its fracture caveat. It describes; it does not conclude — the team chooses the target.') }}</p>
          </details>
        </section>

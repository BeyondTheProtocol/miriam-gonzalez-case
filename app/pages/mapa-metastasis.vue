...
import {
  TRACER, GA_FILL, GA_TEXT, FDG_FILL, FDG_TEXT, PHENO, PHENO_RAMP_CSS, LES, GROUPS, SK_R, SK_HIT,
  BONE3D_KEY, SK_VERTEBRAS, SK_COSTILLAS, SK_TICKS, vertLevelKey, groupKey,
} from '~/utils/mapaFocos'
import type { Pheno, Lesion, LesGroup } from '~/utils/mapaFocos'
/**
...
const vertebrae = computed(() => SK_VERTEBRAS)
/* caja torácica esquemática: 9 pares de costillas que curvan desde la columna dorsal */
const ribs = computed(() => SK_COSTILLAS)
const ticks = SK_TICKS

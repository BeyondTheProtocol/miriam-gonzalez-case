...
const rows = computed<Row[]>(() =>
  locale.value === 'es'
    ? [
        ...
        { alteration: 'ESR1 p.D538G', result: 'Detectada', source: 'ctDNA (Guardant360 + VHIO360, 2026)', category: 'Resistencia endocrina', implication: 'Resistencia adquirida a inhibidores de aromatasa; criterio de entrada a ensayos con elacestrant.', tone: 'info' },
    ...
    : [
        ...
        { alteration: 'ESR1 p.D538G', result: 'Detected', source: 'ctDNA (Guardant360 + VHIO360, 2026)', category: 'Endocrine resistance', implication: 'Acquired resistance to aromatase inhibitors; entry criterion for elacestrant trials.', tone: 'info' },

  ...
  <section :aria-labelledby="'perfil-molecular-detallado-title'">
    <div class="flex items-baseline justify-between flex-wrap gap-2 mb-3">
      ...
      <p class="text-[11px] text-tinta font-mono">
        {{ locale === 'es' ? 'TSO500 2024 + IHC + ctDNA 2026 + PET Ga-68' : 'TSO500 2024 + IHC + 2026 ctDNA + Ga-68 PET' }}
      </p>
    </div>
    <h3
...
const rows = computed<Row[]>(() =>
  locale.value === 'es'
    ? [
        ...
        { alteration: 'Diferenciación NE', result: '~80% (CgA, SYN)', source: 'IHC tejido primario', category: 'Subtipo BC-NED', implication: 'Comportamiento neuroendocrino dominante. Justifica explorar terapias propias de tumores NE (PRRT, regímenes platino).', tone: 'warn' },

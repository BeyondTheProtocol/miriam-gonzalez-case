      ...
      <div class="grid md:grid-cols-2 gap-6 lg:gap-8">
        ...
        <div class="card-base">
          <div class="flex items-center gap-2.5 mb-5">
            <span
              class="w-9 h-9 rounded-xl bg-gold-100 flex items-center justify-center"
            >
              <Icon name="ph:flask-fill" class="w-4.5 h-4.5 text-gold-700" />
            </span>
            <h3 class="font-display font-semibold text-ink-900">
              {{ $t('gofundme.what_title') }}
            </h3>
          </div>
          <p
            v-if="$te('gofundme.what_intro')"
            class="text-sm text-ink-600 leading-relaxed mb-4 italic"
          >
        ...
        <div class="card-base">
          <div class="flex items-center gap-2.5 mb-5">
            <span
              class="w-9 h-9 rounded-xl bg-ocean-50 flex items-center justify-center"
            >
              <Icon
                name="ph:question-fill"
                class="w-4.5 h-4.5 text-ocean-700"
              />
            </span>
            <h3 class="font-display font-semibold text-ink-900">
              {{ $t('gofundme.why_title') }}
            </h3>
          </div>
        ...
        <div class="card-base md:col-span-2 bg-gold-50/40 border-gold-200/50">
          <div class="flex items-center gap-2.5 mb-4">
            <span
              class="w-9 h-9 rounded-xl bg-gold-200/60 flex items-center justify-center"
            >
              <Icon name="ph:eye-fill" class="w-4.5 h-4.5 text-gold-800" />
            </span>
            <h3 class="font-display font-semibold text-ink-900">
              {{ $t('gofundme.transparency_title') }}
            </h3>
          </div>

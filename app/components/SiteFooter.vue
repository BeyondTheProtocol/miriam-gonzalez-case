<template>
  <footer :aria-label="$t('footer.site_footer')" class="bg-cream-card" style="border-top: 1px solid rgba(45,27,61,0.08)">
      ...
      <div class="section-container py-10 sm:py-12 text-center">
        ...
        <div class="flex flex-wrap justify-center items-center gap-12 sm:gap-20">
          <div class="flex flex-col items-center gap-3">
            <img src="/svg/github.svg" alt="GitHub" class="h-10 w-auto object-contain opacity-90" width="40" height="40" />
            <span class="text-cream/80 text-xs font-medium tracking-wide">GitHub</span>
          </div>
          <div class="flex flex-col items-center gap-3">
            <img src="/svg/notion.svg" alt="Notion" class="h-10 w-auto object-contain opacity-90" width="40" height="40" />
            <span class="text-cream/80 text-xs font-medium tracking-wide">Notion</span>
          </div>
          <div class="flex flex-col items-center gap-3">
            <img src="/img/neversurrender.jpeg" alt="Never Surrender" class="h-10 w-auto object-contain rounded-lg"
              width="auto" height="40" />
            <span class="text-cream/80 text-xs font-medium tracking-wide">Never Surrender</span>
          </div>
          <div class="flex flex-col items-center gap-3">
            <a href="https://tahecosmetics.com" target="_blank" rel="sponsored noopener"
              ...
              <span class="text-cream/80 text-xs font-medium tracking-wide">Thae</span>
            </a>
          </div>
        </div>
      </div>
    ...
    <div class="section-wide py-12 sm:py-16">
        ...
        <div>
          ...
          <div class="flex flex-col gap-1.5">
            <a href="https://x.com/miriamgonp" target="_blank" rel="noopener noreferrer"
              class="text-sm text-tinta hover:text-miriam transition-colors" style="text-decoration: none">
              X / Twitter
            </a>
            ...
            <a href="https://gofund.me/3e25cae99" target="_blank" rel="noopener noreferrer"
              class="text-sm text-coral-deep hover:text-coral-hover font-semibold transition-colors" style="text-decoration: none">
              GoFundMe →
            </a>
          </div>
        </div>
      ...
      <div class="mt-8 pt-6 flex flex-col sm:flex-row justify-between items-center gap-2" style="border-top: 1px solid rgba(45,27,61,0.08)">
